  ...
  async function(msg, args, client, command){
    ...
    return client.components.Opendota.userID(msg, args)
      ...
      .then(data => {
        ...
        // return msg.reply({
        //   embed: {
        //     title: odutil.titlePlayer(results, msg.author.locale('playerProfile'), client, player.profile),
        //     description: client.components.Account.socialLinks(profile),
        //     fields: [
        //       {
        //         name: msg.author.locale('recentMatches') + ' > ' + util.Date.custom(results[1][0].start_time * 1000, '[D/M/Y h:m:s]'),
        //         value: table,
        //         inline: true
        //       }
        //     ],
        //     thumbnail: { url: results[0].profile.avatarmedium, height: 40, width: 40 },
        //     footer: { text: msg.author.locale('noteData'), icon_url: client.user.avatarURL },
