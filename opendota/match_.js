...
module.exports = new Command('match+',{
  category : 'Dota 2', help : 'Estadísticas de una partida. R+', args : '<id>', cooldown : 120},
  function(msg, args, command){
    ...
    opendota.request('match',args[1]).then(results => {
      ...
      //   }
      // }
      apijimp.match(results[0]).then(data => {
        // console.log('DATA',data);
        self.createMessage(self.config.guild.generated,`**${msg.author.username}** pidió \`${args[1]}\``,{file : data, name : args[1]+".jpg"}).then(m => {
